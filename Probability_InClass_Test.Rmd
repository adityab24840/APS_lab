...
checkEvent2 = function(data){
  condition1 = (sum(data == 'A') == 4)
  condition2 = (length(unique(ceiling(which(data == 'A')))) == 4)
...
checkEvent5 = function(data){
  ...
  condition3 = (unique(ceiling(which(grepl('A', data)) /5)) != unique(ceiling(which(grepl('Q', data)) /5)))
